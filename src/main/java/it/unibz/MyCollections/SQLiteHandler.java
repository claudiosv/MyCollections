...
public class SQLiteHandler implements DatabaseHandler {
     ...
     */
    @Override
    public AddressRecord insertRecord(AddressRecord record) throws SQLException, RecordNotFoundException, IOException, UserNotFoundException {
     ...
     */
    @Override
    public void updateRecord(AddressRecord record) throws SQLException, RecordNotFoundException {
     ...
     */
    @Override
    public List<AddressRecord> searchRecords(RecordSearchQuery query, int userId) throws SQLException, IOException {
     ...
     */
    @Override
    public List<AddressRecord> searchRecords(RecordSearchQuery query) throws SQLException, IOException {
        logger.entering(getClass().getName(), "searchRecords");
        String sql = query.toLikeQuery();
     ...
     */
    @Override
    public List<AddressRecord> getAllRecords() throws SQLException, IOException {
     ...
     */
    @Override
    public List<AddressRecord> getRecords(int userId) throws SQLException, IOException {
     ...
     */
    @Override
    public AddressRecord getRecord(int userId, int recordId) throws SQLException, IOException, RecordNotFoundException {
        ...
        if (result.next()) {
            AddressRecord databaseRecord = new AddressRecord();
     ...
     * @author Claudio Spiess
     */
    private List<AddressRecord> resultSetConverter(ResultSet result) throws SQLException, IOException {
