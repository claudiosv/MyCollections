...
public interface DatabaseHandler {
     ...
     * @see Record
     */
    AddressRecord insertRecord(AddressRecord record) throws SQLException, RecordNotFoundException, IOException, UserNotFoundException;
     ...
     * @see Record
     */
    void updateRecord(AddressRecord record) throws SQLException, RecordNotFoundException;
     ...
     * @see Record
     */
    List<AddressRecord> searchRecords(RecordSearchQuery query, int userId) throws SQLException, IOException;
     ...
     * @see Record
     */
    List<AddressRecord> searchRecords(RecordSearchQuery query) throws SQLException, IOException;
     ...
     * @see Record
     */
    List<AddressRecord> getAllRecords() throws SQLException, IOException;
     ...
     * @see Record
     */
    List<AddressRecord> getRecords(int userId) throws SQLException, IOException;
     ...
     * @author Claudio Spiess
     */
    AddressRecord getRecord(int userId, int recordId) throws SQLException, IOException, RecordNotFoundException;
