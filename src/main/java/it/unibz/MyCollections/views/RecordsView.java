...
public class RecordsView {
     ...
     */
    private ObservableList<AddressRecord> data;
    ...
    public Pane box(Login parentStage) {
        ...
        button.setOnAction(event -> {
            ...
            AddressRecord rowData = new AddressRecord();
            ...
            AddressRecord newData = view.show();
        ...
        TableColumn<AddressRecord, ImageView> imageCol = new TableColumn<AddressRecord, ImageView>("Image");
        imageCol.setCellValueFactory(
                new PropertyValueFactory<AddressRecord, ImageView>("imageView"));
        imageCol.setPrefWidth(53);

        TableColumn<AddressRecord, String> firstNameCol = new TableColumn<AddressRecord, String>("First Name");
        ...
        firstNameCol.setOnEditCommit(
                t -> {
                    ...
                    AddressRecord record = t.getTableView().getItems().get(
        ...
        TableColumn<AddressRecord, String> lastNameCol = new TableColumn<AddressRecord, String>("Last Name");
        ...
        TableColumn<AddressRecord, String> companyNameCol = new TableColumn<AddressRecord, String>("Company");
        ...
        TableColumn<AddressRecord, String> addressCol = new TableColumn<AddressRecord, String>("Address");
        ...
        TableColumn<AddressRecord, String> telephoneCol = new TableColumn<AddressRecord, String>("Telephone");
        ...
        TableColumn<AddressRecord, String> emailCol = new TableColumn<AddressRecord, String>("Email");
        ...
        table.setOnKeyPressed(keyEvent -> {
            final AddressRecord selectedItem = (AddressRecord) table.getSelectionModel().getSelectedItem();
        ...
        table.setRowFactory(tableView -> {
            final TableRow<AddressRecord> row = new TableRow<>();
        ...
        parentStage.getMenuBar().getFileMenu().getImportDataMenuItem().setOnAction(event -> {
            ...
            List<AddressRecord> importedRecords = dataView.show();
            for (AddressRecord record : importedRecords) {
                try {
